...
main:
    ...
    bne  a0, x0 ,main_pass
    la   a0, str_fail        # load string
    li   a1, fail_str_size   # load string length
    jal  ra, print_str       # go to print string
    li   a0, 1               # return 1
    j    main_exit
main_pass:
    la   a0, str_all_passed  # load string
    li   a1, pass_str_size   # load string length
    jal  ra, print_str       # go to print string
    li   a0, 0               # return 0
main_exit:
...
print_str:
    ...
    mv   t0, a0
    mv   t1, a1
    li   a7, 64     # SYSCALL 4 (Print String)
    li   a0, 1
    mv   a1, t0
    mv   a2, t1
    ecall
